...
public class SudokuGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        FixBN.setText("Fix");
        FixBN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                FixBNActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(FixBN, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void FixBNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FixBNActionPerformed
        // TODO add your handling code here:
		if (SELECTED_PANEL.ACTUAL_VALUE == 0) {
			for (int i = 0; i < 9; i++) {
				for (int j = 0; j < 9; j++) {
					if (SudokuGUI.Block[i][j].ACTUAL_VALUE != 0) {
						SudokuGUI.Block[i][j].fix(SudokuGUI.Block[i][j].ACTUAL_VALUE);
					}
				}
			}
			FixBN.setVisible(false);
		}
		else {
			JOptionPane.showMessageDialog(this, "Please select an empty cell first.", "Error!", JOptionPane.ERROR_MESSAGE);
		}
    }//GEN-LAST:event_FixBNActionPerformed
    ...
    public javax.swing.JButton FixBN;
	...
	public void setNumber(KeyEvent evt) {
		getXY();
		switch(evt.getKeyCode()){
			case KeyEvent.VK_UP :	//UP key
			{
				do{
					if (SEL_Y < 3) {
						SEL_X = (SEL_X < 3) ? (SEL_X + 6) : (SEL_X - 3);
						SEL_Y = SEL_Y + 6;
					}
					else{
						SEL_Y = SEL_Y - 3;
					}
				} while(Block[SEL_X][SEL_Y].isFixed());
			...
			case KeyEvent.VK_LEFT :	//LEFT key
			{
				do{
					if (SEL_Y % 3 == 0) {
						SEL_X = (SEL_X % 3 == 0) ? (SEL_X + 2) : (SEL_X - 1);
						SEL_Y = SEL_Y + 2;
					}
					else{
						SEL_Y = SEL_Y - 1;
			...
			case KeyEvent.VK_RIGHT :	//RIGHT key
			{
				do{
					if (SEL_Y % 3 == 2) {
						SEL_X = (SEL_X % 3 == 2) ? (SEL_X - 2) : (SEL_X + 1);
						SEL_Y = SEL_Y - 2;
					}
					else{
						SEL_Y = SEL_Y + 1;
		...
		clickedPanel(Block[SEL_X][SEL_Y]);
//		for(int i = 0; i<10; i++){
//			HintBox[i].setSelected(SELECTED_PANEL.SELECTED_VALUES[i]);
//		}
//		HintBox[2].setSelected(true);
//		System.out.println("p");
	}

	public void setNumber(int keyChar) {
		int value = keyChar - '0';
		if (value >= 0 && value <= 9){
	...
	private boolean getXY() {
	for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 9; j++) { 
				if(Block[i][j].equals(SELECTED_PANEL)){
					SEL_X = i;
					SEL_Y = j;
					return true;
				}
